        ...
        >
            ...
            <div className="flex flex-wrap items-end justify-center gap-10">
                {data.map((item, index) => (
                    <div
                        key={index}
                        className={`group w-full max-w-80 rounded-xl p-6 pb-10 ${item.mostPopular ? "bg-gray-800 text-white" : "bg-white border border-slate-200"}`}
                    >
                        <div
                        ...
                        <div className="mt-2 flex flex-col">
                            {item.features.map((feature, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center gap-2 border-b py-3 ${item.mostPopular ? "border-gray-700" : "border-gray-200"}`}
                                >
                                    <div
                                        className={`rounded-full p-1 ${item.mostPopular ? "bg-white/10" : "bg-gray-800"}`}
                                    >
                                        <CheckIcon
